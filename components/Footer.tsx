    ...
    <footer className="bg-[#111827] border-t border-gray-700/50">
      <div className="container mx-auto px-6 py-6 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left">
        ...
        <div className="flex space-x-6">
          <a href="https://www.linkedin.com/in/abem-tadele-854508227/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-sky-400 transition-colors duration-300">
          ...
          <a href="https://github.com/abemt" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-sky-400 transition-colors duration-300">
