...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-md fixed top-0 left-0 right-0 z-50 shadow-sm border-b border-slate-200/50">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        <a href="#home" onClick={(e) => handleNavClick(e, '#home')} className="text-3xl font-bold">
          <span className="bg-gradient-to-r from-sky-600 to-indigo-600 text-transparent bg-clip-text">
            Abem T.
          </span>
        </a>
