      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          <a
            ...
            className="inline-flex items-center justify-center bg-sky-500 text-white font-bold py-3 px-8 rounded-full hover:bg-sky-600 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-sky-500/20 text-lg w-full sm:w-auto"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center bg-gray-800 text-white font-bold py-3 px-8 rounded-full hover:bg-gray-750 hover:text-sky-400 border border-gray-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-gray-900/40 text-lg w-full sm:w-auto"
          >
